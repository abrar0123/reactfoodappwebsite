      ...
      <div class="container px-4 pt-24 mx-auto md:pt-32 lg:px-0 dark:bg-gray-900">
        ...
        <div class="flex items-center">
          ...
          <div>
            <label
              for="toggle-example"
              class="relative flex items-center mx-4 cursor-pointer"
            >
                    ...
                    <tr class="bg-gray-50 dark:bg-gray-900">
                      ...
                      <td class="p-4">
                        <div class="flex items-center justify-end space-x-1">
                          ...
                          <span class="flex-shrink-0 text-xs font-medium text-gray-900 sm:text-sm md:text-base dark:text-white">
                            1 User
                          </span>
                        </div>
                      </td>
          ...
          <div class="grid gap-8 lg:grid-cols-3">
            ...
            <div>
              <div class="mb-10">
                ...
                <ul class="pl-4 mb-4 list-disc">
                  <li class="mb-2 text-gray-600">
                    <span class="font-medium cursor-pointer text-primary-600 hover:underline dark:text-primary-500">
              ...
              <div class="mb-10">
                ...
                <p class="mb-4 text-gray-600 dark:text-gray-400">
                  As long as it is not a design resource that you will re-sell,
                  it is alright to use it for commercial purposes.
                </p>
                <p class="mb-4 text-gray-600 dark:text-gray-400">
                  Find out more information by{" "}
                  <Link
              ...
              <div class="mb-10">
                ...
                <p class="mb-4 text-gray-600 dark:text-gray-400">
                  ...
                  be available on the invoice. After the purchase, you will get
            ...
            <div>
              ...
              <div class="mb-10">
                ...
                <p class="mb-4 text-gray-600 dark:text-gray-400">
                  After initializing the checkout process from Paddle, you will
                  be able to see a text "Add VAT code". Click on that, and add
                  the VAT code for your company. This will also remove the extra
