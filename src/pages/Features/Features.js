    ...
    <div class="bg-red-100">
      ...
      <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <Button />
          <div class=" saturate-200 backdrop-brightness-150	  transition delay-700 hover:contrast-200 text-center pb-3 mt-2  rounded-xl shadow-md shadow-cyan-500/50 opacity-90 hover:cursor-pointer	">
